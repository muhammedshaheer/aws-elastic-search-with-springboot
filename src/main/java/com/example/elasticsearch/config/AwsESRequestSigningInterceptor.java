...
public class AwsESRequestSigningInterceptor implements HttpRequestInterceptor {

    private final String service;
    private final Signer signer;
    private final AWSCredentialsProvider awsCredentialsProvider;

    public AwsESRequestSigningInterceptor(String service, Signer signer, AWSCredentialsProvider awsCredentialsProvider) {
